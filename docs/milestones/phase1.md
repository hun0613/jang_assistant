...
|-----------|-------|-------------|------|
| #33 | Supabase 프로젝트 세팅 및 Next.js 연동 | Supabase 프로젝트 생성, 환경변수 설정, Supabase Client 유틸 구성, Next.js와 연동 확인 | ⬜ 미착수 |
| #34 | DB 테이블 스키마 설계 및 생성 | 현재 localStorage 데이터 모델(CartItemType 등)을 분석하여 Supabase 테이블 스키마 설계 및 생성. 익명 세션 ID 기반 데이터 식별 포함 | ⬜ 미착수 |
