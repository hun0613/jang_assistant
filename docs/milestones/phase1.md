...
| #36 | 품목(CartItem) CRUD API 구현 | 품목 추가/조회/수정/삭제 Server Actions 구현 | ✅ 완료 |
| #37 | 프론트엔드 localStorage → Supabase 마이그레이션 | 기존 localStorage 기반 로직을 Supabase API 호출로 전환, 동작 검증 | ✅ 완료 |
