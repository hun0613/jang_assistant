...
| #49 | preferredRegion='icn1' 설정 롤백 | Hobby 플랜에서 사용 불가능한 preferredRegion 설정 제거 | ⬜ 미착수 |
| #50 | Supabase 리전 이전 (ap-northeast-2 → us-east-1) | Vercel iad1과 같은 리전으로 Supabase 이전하여 네트워크 레이턴시 해소 | ⬜ 미착수 |
